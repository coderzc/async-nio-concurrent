 ...
 * <p>
 * DNS wildcard is supported as hostname, so you can use {@code *.io.netty.io} to match both {@code io.netty.io}
 * and {@code downloads.io.netty.io}.
 * </p>
 */
public class DomainNameMapping<V> implements Mapping<String, V> {
     ...
     * For example, you can use {@code *.io.netty.io} to match {@code io.netty.io} and {@code downloads.io.netty.io}.
     * </p>
     *
