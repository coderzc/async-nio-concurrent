...
public final class ZlibCodecFactory {
    ...
    static {
        noJdkZlibDecoder = SystemPropertyUtil.getBoolean("io.io.netty.noJdkZlibDecoder",
                PlatformDependent.javaVersion() < 7);
        logger.debug("-Dio.io.netty.noJdkZlibDecoder: {}", noJdkZlibDecoder);

        noJdkZlibEncoder = SystemPropertyUtil.getBoolean("io.io.netty.noJdkZlibEncoder", false);
        logger.debug("-Dio.io.netty.noJdkZlibEncoder: {}", noJdkZlibEncoder);
